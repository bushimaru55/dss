...
- [SPEC-TI-014 §19.6 observation trace と logical path](../specs/table-intelligence/04_system/SPEC-TI-014-api.md#s196-observation-trace-vs-logical-path)（013 `evidence` ≠ 006 path 正本）
